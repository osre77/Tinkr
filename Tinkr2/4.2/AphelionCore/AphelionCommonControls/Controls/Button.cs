        ...
        private void DrawBackground()
        {
            ...
            switch (_scale)
            {
                case ScaleMode.Center:
                    Core.Screen.DrawImage(Left + (_w / 2 - _img.Width / 2), Top + (_h / 2 - _img.Height / 2), _img, 0, 0, _img.Width, _img.Height);
                    break;
                ...
                case ScaleMode.Stretch:
                    Core.Screen.StretchImage(Left, Top, _img, _w, _h, 256);
                    break;
                case ScaleMode.Tile:
                    Core.Screen.TileImage(Left, Top, _img, _w, _h, 256);
                    break;
            }
        }
