        ...
        protected override void OnRender(int x, int y, int w, int h)
        {
            ...
            for (int i = 0; i < _items.Length; i++)
            {
                if (y + _lineHeight > Top)
                {
                    ...
                    {
                        if (i == _selIndex)
                            Core.Screen.DrawTextInRect(_items[i].Text, _txtX, y + (_lineHeight / 2 - _font.Height / 2), _txtW, _font.Height, Bitmap.DT_None, _selFore, _font);
                        else
                    ...
                    if (_showCheckboxes && _items[i].AllowCheckbox)
                    {
                        ...
                        {
                            if (Enabled)
                                Core.Screen.DrawRectangle(0, 0, chkX, y + 4, _chkH, _chkH, 0, 0, Core.SystemColors.ControlBottom, Left, y + 4, Core.SystemColors.ControlBottom, Left, y + 4 + (_chkH / 2), 256);
                            else
                        ...
                        else
                        {
                            ...
                            if (Enabled)
                                Core.Screen.DrawRectangle(0, 0, chkX + 1, y + 5, _chkH - 2, _chkH - 2, 0, 0, Core.SystemColors.ControlTop, Left, y + 4, Core.SystemColors.ControlBottom, Left, y + 4 + (_chkH / 2), 256);
                            else
