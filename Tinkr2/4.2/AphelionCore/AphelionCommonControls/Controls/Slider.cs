...
namespace Skewworks.NETMF.Controls
{
    ...
    public class Slider : Control
    {
        ...
        protected override void TouchMoveMessage(object sender, point e, ref bool handled)
        {
            ...
            if (_orientation == Orientation.Horizontal)
                Value = _min + (int)((_max - _min) * ((float)e.X) / (float)(Width - _gripSize));
            else
                Value = _min + (int)((_max - _min) * ((float)e.Y) / (float)(Height - _gripSize));
        ...
        protected override void OnRender(int x, int y, int w, int h)
        {
            ...
            if (_orientation == Orientation.Vertical)
            {
                ...
                iOffset = y + (int)((Height - _gripSize) * ((float)(_val - _min) / (float)(_max - _min)));
            ...
            else
            {
                ...
                iOffset = x + (int)((Width - _gripSize) * ((float)(_val - _min) / (float)(_max - _min)));
