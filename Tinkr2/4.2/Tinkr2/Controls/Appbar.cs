...
namespace Skewworks.Tinkr.Controls
{
    ...
    public class Appbar : Control
    {
        ...
        {
            get { return _x; }
            set { return; } // throw new Exception("Cannot modify Appbar X"); }
        }

        public override int Y
        {
            get { return _y; }
            set { return; } // throw new Exception("Cannot modify Appbar Y"); }
        }
        ...
        public void AddIcon(AppbarIcon icon)
        {
            ...
            {
                AppbarIcon[] tmp = new AppbarIcon[_icons.Length + 1];
        ...
        {
            if (_menus == null)
                _menus = new AppbarMenuItem[] { menu };
            else
            {
                AppbarMenuItem[] tmp = new AppbarMenuItem[_menus.Length + 1];
        ...
        private void DrawMenuItems()
        {
            ...
            if (_requiredDisplaySize > _scrollArea.Height)
            {
                ...
                i = (int)((_scrollArea.Height - _gripSize) * ((float)_scrollValue / (float)_scrollValueRange));
