...
namespace Skewworks.Tinkr.Modal
{
    ...
    public class SelectDirectory
    {
        ...
        public static string Show(string title, Font titleFont, Font bodyFont)
        {
            ...
            Treeview tv1 = new Treeview("tv1", bodyFont, 8, 16 + titleFont.Height, frmModal.Width - 16, frmModal.Height - 41 - bodyFont.Height - titleFont.Height);
            ...
            Button btnSelect = new Button("btnSel", "Select", bodyFont, 8, frmModal.Height - 22 - bodyFont.Height);
            ...
            btnSelect.Tap += (object sender, point e) => ReturnSelection(tv1);
            frmModal.AddChild(btnSelect);

            Color cR1 = ColorUtility.ColorFromRGB(226, 92, 79);
            Color cR2 = ColorUtility.ColorFromRGB(202, 48, 53);
            Button btnCancel = new Button("btnCancel", "Cancel", bodyFont, 0, btnSelect.Y, Colors.White, Colors.White, Colors.DarkRed, Colors.DarkRed);
